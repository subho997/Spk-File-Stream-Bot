    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  Contact Developer [Suvo](https://telegram.me/CallOwner_Bot) he will help you.",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ʙᴏss](https://telegram.me/CallOwner_Bot)",
                disable_web_page_preview=True
            )
            return
...
async def channel_receive_handler(bot, broadcast):
    ...
    try:  # This is the outer try block
        ...
        await bot.edit_message_reply_markup(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("🎥 𝑺𝑻𝑹𝑬𝑨𝑴 🌸", url=🎥 𝑺𝑻𝑹𝑬𝑨𝑴),
                 InlineKeyboardButton("💾 𝑫𝑶𝑾𝑵𝑳𝑶𝑨𝑫 🌸", url=💾 𝑫𝑶𝑾𝑵𝑳𝑶𝑨𝑫)]
            ])
        )
